...
"boolean" { return TokenType.tok_boolean; }
"integer" { return TokenType.tok_integer; }
"write" { return TokenType.tok_write; }
"read" { return TokenType.tok_read; }
"writeline" { return TokenType.tok_writeln; }

"array" { return TokenType.tok_array; }
"of" { return TokenType.tok_of; }
"record" { return TokenType.tok_record; }
"var" { return TokenType.tok_var; }
"procedure" { return TokenType.tok_procedure; }
"begin" { return TokenType.tok_begin; }
"end" { return TokenType.tok_end; }
"if" { return TokenType.tok_if; }
"then" { return TokenType.tok_then; }
"else" { return TokenType.tok_else; }
"while" { return TokenType.tok_while; }
"do" { return TokenType.tok_do; }
"elsif" { return TokenType.tok_elsif; }
"const" { return TokenType.tok_const; }
"module" { return TokenType.tok_module; }
"type" { return TokenType.tok_type; }
...
"div" { return TokenType.tok_divide; }
"mod" { return TokenType.tok_mod; }
"&" { return TokenType.tok_and; }
"or" { return TokenType.tok_or; }
"~" { return TokenType.tok_not; }

{Octal} { if (yylength() > 12)
            throw new IllegalIntegerRangeException();
            return TokenType.tok_octal; }
{Decimal} { if (yylength() > 12)
            throw new IllegalIntegerRangeException();
            return TokenType.tok_decimal; }
{IllegalNumber} { throw new IllegalIntegerException(); }
{IllegalOctal} { throw new IllegalOctalException(); }

{Comment} { return TokenType.tok_comment; }
{WhiteSpace} { return TokenType.tok_space; }

{UnMatchedComment} { throw new MismatchedCommentException(); }
